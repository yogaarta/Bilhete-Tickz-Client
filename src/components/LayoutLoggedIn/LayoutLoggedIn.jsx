         ...
         <div className={Styles.ContainerLayout}>
                  ...
                  <Navbar.Collapse id="basic-navbar-nav">
                     ...
                     <div className="d-flex gap-4 justify-content-md-end justify-content-end align-items-center">
                        ...
                        {loginData && loginData.token ? (
                           <>
                              <Image src={userInfo.pictures ? userInfo.pictures : Default} width={'50px'} height={'50px'} className={Styles.profPict} onClick={() => router.push('/profile')} />
                              <div onClick={() => setShow(true)} className={`${Styles.logoutButton}`}>
                                 Logout
                              </div>
                           </>
                        ) : (
            ...
            <footer className={`${Styles.FooterLayout}`}>
               <div className="row justify-content-around px-5">
                  ...
                  <div className={`${Styles.listFooter} mt-3 col-12 col-md-8 d-flex justify-content-around`}>
                     <ul>
                        <h5>Explore</h5>
                        <li>Cinemas</li>
                        <li>Movies list</li>
